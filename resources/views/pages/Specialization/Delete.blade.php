...
<div class="modal fade" id="Delete_Student{{$Specialization->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('Specialization.destroy','test')}}" method="post">
                    ...
                    <input type="text" readonly value="{{$Specialization->name}}" class="form-control">
