                    ...
                    <div class="contact__widget__item">
                        ...
                        <div class="contact__widget__item__text">
                            ...
                            <span data-aos="fade-up-right" data-aos-delay="2800" style="color: #ffffff;">
                                    The verification that is clear
                                </span>
                        </div>
                    </div>
                </div>
...
{{--            <form method="POST" data-success-id="thank" data-error-id="error" class="form request__form"--}}
{{--                  data-form="">--}}

                <form method="POST" data-success-id="thank"  action="{{route('students.signup') }}"  data-error-id="error" class="form request__form" data-form="">
                    @csrf
                    @include('sessions')
                <div class="form__row">
                    <div class="form__column">
                        ...
                        <div class="fieldset">
                            ...
                            <div class="fieldset__focus">
                                <input type="text" name="year" data-field-name="year" class="input"
                                       data-required="">
                            </div>
                            <div class="error">
                                enter correct Name
                        ...
                        <div class="fieldset">
                            ...
                            <div class="fieldset__focus">
                                <input type="text" name="Passport_ID_Student" data-field-name="Passport_ID_Student" class="input"
                                       data-required="">
                            </div>
                            <div class="error">
                                enter correct Name
